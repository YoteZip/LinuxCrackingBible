...
## Lutris
[Lutris](https://github.com/lutris/lutris) is currently my preferred tool for configuring cracked games, but you can use alternatives like [Faugus](https://github.com/Faugus/faugus-launcher) or [Bottles](https://github.com/bottlesdevs/Bottles) if that's what you're comfortable with. I'll only be walking through configuring Lutris, but most of the information should be generally applicable to other tools as well - you'll just need to figure out how to apply it with your tool.

**March 2026 NOTE**: Lutris's developers have recently purposefully obfuscated their usage of AI-coding in their public repo, and have had a lot of Bad Takes on AI in at least the following places: [one](https://github.com/lutris/lutris/issues/6506#issuecomment-3976118573), [two](https://github.com/lutris/lutris/discussions/6530), [three](https://github.com/lutris/lutris/discussions/6528). Coincidentally, I've also seen many reports of the recent v0.5.20+ Lutris versions crashing and breaking everyone's previously-working game libraries (wonder why). Given all that, I just want to make a quick note that I'm no longer officially encouraging the use of Lutris, and am actively on the lookout for something better. [Faugus](https://github.com/Faugus/faugus-launcher) checks a lot of boxes, but it seems to only support UMU-based wine runners, which don't play nice with a handful of games. DLL overriding is also a bit clunky with Faugus, but it is at least still possible through using the raw `WINEDLLOVERRIDES` environment variable as a Launch Argument. Same story with games that need DXVK-NVAPI disabled (which is done through `PROTON_DISABLE_NVAPI=1`). Other than those points, I think Faugus is overall a better option than Lutris for most people, but I'll keep Lutris as the basis for this guide until Faugus is capable of running the few games that are finicky about wanting Wine-GE/Kron4ek runners.
